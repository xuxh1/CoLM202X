...
! ===============================================================
   ...
   logical, intent(in) :: set_defaults
      ...
      CALL sync_hist_vars_one (DEF_hist_vars%hr_vr              , set_defaults) 
      CALL sync_hist_vars_one (DEF_hist_vars%fphr               , set_defaults) 
      CALL sync_hist_vars_one (DEF_hist_vars%pot_f_nit_vr       , set_defaults) 
