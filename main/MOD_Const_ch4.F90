...
!=======================================================================
	...
	data (s_con(3,iloop),iloop=1,4) /1911_r8, -113.7_r8, 2.967_r8, -0.02943_r8/ ! CO2
...
!------------------------------------------------------------------
   ...
   type CH4_type
      ...
      real(r8) :: vmax_ch4_oxid = 1.25e-5_r8       ! oxidation rate constant (params:1.25e-5 code:45.e-6_r8 * 1000._r8 / 3600._r8) (doc:Ro,max Baseline:1.25e-5 Range:1.25e-6~1.25e-4 Unit:mol m-3 s-1)
      real(r8) :: vmax_oxid_unsat = 1.25e-6_r8     ! (params:1.25e-6 code:45.e-6_r8 * 1000._r8 / 3600._r8 / 10._r8) (doc:Ro,max Baseline:1.25e-5 Range:1.25e-6~1.25e-4 Unit:mol m-3 s-1)
      ...
      real(r8) :: wet_lai = 4._r8 ! Wetland leaf area index [m2/m2]
...
CONTAINS
   ...
   SUBROUTINE read_ch4_namelist (nlfile)
   ...
   namelist /nl_colm_ch4_parameter/ DEF_CH4,DEF_CH4_hydrology
      ...
      IF (p_is_master) THEN
         ...
         read(10, nml=nl_colm_ch4_parameter, iostat=ierr)
         IF (ierr /= 0) THEN
            CALL CoLM_Stop (' ***** ERROR: Problem reading namelist: '// trim(DEF_file_METHANE_para))
         ENDIF
         close(10)
      ENDIF
